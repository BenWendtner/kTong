...
# Create Products
Product.create(id: 1, name: 'Regalelement', color: 'Naturweiß', category_id: 4, price: 0)
Product.create(id: 2, name: 'Regalelement', color: 'Möbelbraun', category_id: 4, price: 0)
Product.create(id: 3, name: 'Fächer', color: 'Naturweiß', category_id: 5, price: 0)
Product.create(id: 4, name: 'Fächer', color: 'Möbelbraun', category_id: 5, price: 0)
Product.create(id: 5, name: 'Deckel', color: 'Naturweiß', category_id: 6, price: 0)
Product.create(id: 6, name: 'Sockel', color: 'Naturweiß', category_id: 7, price: 0)

Product.create(id: 7, name: 'Regalelement', color: 'Naturweiß', category_id: 8, price: 0)
Product.create(id: 8, name: 'Regalelement', color: 'Möbelbraun', category_id: 8, price: 0)
Product.create(id: 9, name: 'Fächer', color: 'Naturweiß', category_id: 9, price: 0)
Product.create(id: 10, name: 'Fächer', color: 'Möbelbraun', category_id: 9, price: 0)
Product.create(id: 11, name: 'Deckel', color: 'Naturweiß', category_id: 10, price: 0)
Product.create(id: 12, name: 'Sockel', color: 'Naturweiß', category_id: 11, price: 0)
